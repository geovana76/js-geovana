...
<head>
    ...
    <title>loucas aventuras</title>
</head>
<body>
    <main>
        <div class="passo ativo" id="passo-0">
            <img src="img/cenario-passo0.png" alt="">
            <p>Um dia desses, dentro de um livro da biblioteca da escola, eu descobri uma carta antiga sobre uma cidade perdida, escondida por riquezas e belezas naturais. Na carta a autora deixa algumas pistas para encontrar essa cidade e eu decidi segui-las!</p>
            <button class="btn-proximo" data-proximo="1">terras de azura</button>
            <button class="btn-proximo" data-proximo="2">valtoria</button>
        </div>
        <div class="passo" id="passo-1">
            <p>Você começa sua jornada em nas terras de azura , subindo o Pico da montanha ao amanhecer para encontrar a primeira pista.</p>
            <button class="btn-proximo" data-proximo="3">Procurar a pista no topo do pico</button>
            <button class="btn-proximo" data-proximo="4">Desistir e voltar para casa</button>
        </div>
        <div class="passo" id="passo-2">
            <p>Em Valtoria, você visita a histórica cidade de valtia . Na carta, uma das pistas indica que para localizar a entrada para a cidade perdida você deve procurar a próxima pista em um dos pontos turísticos da cidade. Por qual você começa?</p>
        ...
        <div class="passo" id="passo-3">
            <p>No topo do Pico da montanha, você encontra uma antiga inscrição apontando que a próxima pista está
                localizada em atlanta.</p>
            <button class="btn-proximo" data-proximo="7">Seguir para atlanta</button>
        </div>
        ...
        <div class="passo" id="passo-5">
            <p>Nas igrejas de Valtoria, você descobre um mapa antigo escondido atrás de um altar, apontando que a próxima
                pista está em Valtia.</p>
            <button class="btn-proximo" data-proximo="7">Viajar para Valtia</button>
        </div>

        <div class="passo" id="passo-6">
            <p>Explorando as praias, você encontra uma caverna escondida, mas ela leva a um beco sem saída.</p>
            ass="passo" id="passo-7">
            <p>Em Azura, a busca pela cidade perdida se intensifica. Você se depara com um rio bifurcado.</p>
        ...
        <div class="passo" id="passo-11">
            <img src="img/cenario-passo11-cidade-perdida.png" alt="encontrando uma cidade maravilhosa perdida em Azura">
